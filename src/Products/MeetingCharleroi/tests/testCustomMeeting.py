...
class testCustomMeeting(MeetingCharleroiTestCase, mctcm):
    ...
    def test_pm_FullInsertingProcess(self):
        ...
        self.assertEquals([
            (item.getListType(), item.getProposingGroup(), item.getGroupInCharge(),
            ...
            [('normal', police_uid, gic1_uid,
             ...
             ('late', police_uid, gic1_uid,
              (), (), (), 'remboursement'),
             ('depose', police_uid, gic1_uid,
              (), (), (), 'remboursement'),
             ('normal', police_uid, gic1_uid,
              ('meeting-config-council',), (), (), 'indeterminee'),
             ('normal', police_compta_uid, gic1_uid,
              ('meeting-config-council',), ('meeting-config-council',), (), 'indeterminee'),
             ('normal', police_compta_uid, gic1_uid,
              ('meeting-config-council',), ('meeting-config-council',), (), 'indeterminee'),
             ('normal', police_uid, gic1_uid,
              ('meeting-config-council',), (), ('meeting-config-council',), 'indeterminee'),
             ...
             ('normal', police_uid, gic1_uid,
              (), (), (), 'communication'),
             ('normal', self.developers_uid, gic1_uid,
              (), (), (), 'remboursement'),
             ('normal', self.developers_uid, gic1_uid,
              (), (), (), 'remboursement'),
             ('normal', self.vendors_uid, gic2_uid,
              (), (), (), 'remboursement'),
             ('normal', self.vendors_uid, gic2_uid,
              (), (), (), 'remboursement'),
             ('late', self.developers_uid, gic1_uid,
              (), (), (), 'remboursement'),
             ('late', self.developers_uid, gic1_uid,
              (), (), (), 'remboursement'),
             ('depose', self.developers_uid, gic1_uid,
              (), (), (), 'remboursement'),
             ('normal', self.developers_uid, gic1_uid,
              ('meeting-config-council',), (), (), 'indeterminee'),
             ('normal', self.developers_uid, gic1_uid,
             ...
             ('normal', self.vendors_uid, gic2_uid,
              ('meeting-config-council',), (), ('meeting-config-council',), 'indeterminee'),
             ('late', self.vendors_uid, gic2_uid,
              ('meeting-config-council',), (), (), 'indeterminee'),
             ('late', self.vendors_uid, gic2_uid,
              ('meeting-config-council',), ('meeting-config-council',), (), 'indeterminee'),
             ('late', self.vendors_uid, gic2_uid,
              ('meeting-config-council',), ('meeting-config-council',), ('meeting-config-council',), 'indeterminee'),
             ('normal', self.vendors_uid, gic2_uid,
              (), (), (), 'conseil-communal-arret-de-lordre-du-jour'),
             ('normal', self.vendors_uid, gic2_uid,
              (), (), (), 'communication'),
             ('normal', self.vendors_uid, gic2_uid,
              (), (), (), 'communication'),
